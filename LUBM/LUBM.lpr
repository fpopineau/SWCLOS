;; -*- lisp-version: "8.1 [Windows] (Sep 3, 2009 9:08)"; cg: "1.103.2.10"; -*-

(in-package :cg-user)

(define-project :name :LUBM
  :modules (list (make-instance 'module :name "load-lubm")
                 (make-instance 'module :name "queries"))
  :projects (list (make-instance 'project-module :name
                                 "../SWCLOS/OWL/leanOWL.lpr"
                                 :show-modules nil))
  :libraries nil
