...
;;; of digits and point to an appropriate cannonical value, e.g., bignum or float. Then,
...
;;; See also <disjoint-p> on the the discussion on disjointness of xsd datatypes.
