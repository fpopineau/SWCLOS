...
(cl:defpackage :gx
  ...
  (:export rsc-object-p rdf-class-p rdf-metaclass-p strict-class-p rdf-instance-p datatype-p
           ...
           subproperty superproperty-of subproperty-of name
       ...
       (|rdfs|:|Resource| ; type is not rdfs:Class
        ...
        (when
            (handler-case
              ...
              (conditions:illegal-type-specifier () ;(format t "Illegal type: ~S.~%" object) 
		()))
          (return-from %typep (values nil t)))
