...
(excl:defsystem :RDF (:pretty-name "RDF subsystem of SWCLOS"
  ...
  (:module :Rdf          "RDF/Rdf"          (:load-before-compile :packages :NameSpace :RDFShare))
  (:module :RdfReader    "RDF/RdfReader"    (:load-before-compile :packages))
